...
** parameter used for the 2nd objective

totcost(daily_set)       the optimal total cost which will get relaxed in the 2nd optimization
...
*demand parameters
    ...
    demand_inc(t,n)     electricity demand increase for brute force approach
...
*    genup           upload table for generation
    ...
    TC_up           upload table for total costs
...
* Initialize demand_inc to zero
    demand_inc(t,n) = 0;
    
* Increase demand by 1 MW for hour 1 of all days
    demand_inc(t,n)$(hour_T('h1',t)) = 1;
...
*    mr_pos('DE') = CP_up('Minute_pos') ;
*    mr_neg('DE') = CP_up('Minute_neg') ;
