Variables
    COSTS           total generation costs [bn �]
;
...
Equations
    objective            objective function minimizes the TOTAL EMISSIONS in the system
...
objective..      COSTS =E= sum(t$(ord(t)>=x_down and ord(t)<=x_up),
...
%min_downtime%         + sum((Thermal,n)$cap(thermal,n,t), SDown(Thermal,n,t) * sdc(Thermal,n,t) )
...
energy_balance(n,t)$(ord(t)>=x_down and ord(t)<=x_up)..     DEMAND(t,n) + demand_inc(t,n) + cap('PSP',n,t)*af_hydro('PSP',n,t)*(1-share_PSP_daily)
=E=
                                                 sum(i, g(i,n,t))
...
shutdown_constraint(Thermal,n,t)$(ord(t)>=x_down and ord(t)<=x_up)..  p_on(Thermal,n,t-1)- p_on(Thermal,n,t) =L= SDown(Thermal,n,t)
;

min_offtime(Thermal,n,t)$( ord(t)>=x_down  and ord(t)<=x_up and cap(Thermal,n,t) )..
        sum(tt$(ord(tt) < ord(t) and ord(tt) >= (ord(t)-downtime(Thermal)) ), SDown(Thermal,n,tt)) + P_on(Thermal,n,t) =l= cap(Thermal,n,t)*af_overall(Thermal,n,t)-outages(Thermal,n,t)
;
...
%min_downtime%   shutdown_constraint
%min_downtime%   min_offtime
